...
urlpatterns = [
    ...
    path('baralhos/editar/<int:baralho_id>/adicionar-carta/', views.adicionar_carta_ajax, name='adicionar_carta'),
    path('baralhos/editar/<int:baralho_id>/deletar-carta/<int:carta_id>/', views.deletar_carta_ajax, name='deletar_carta'),
